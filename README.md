...
- **🔬 Educational Physics Visualizations:** Exposes the real-time math and mechanics behind gameplay:
  - 📐 **Integrated Crane Oscillation Display (Pendulum Physics):** A prominent, readable protractor interface integrated directly into the swinging crane assembly. The entire gauge rotates with the crane movement while the measuring pointer arm sweeps dynamically across clearly numbered degree labels (0°, ±15°, ±30°, ±45°, ±60°). Features a bold digital "ANGLE: XX°" readout, smart proximity fading (fading smoothly to 35% opacity when the tower approaches), and dynamic color-coded feedback for potential energy ranges (Green: 0°-15°, Yellow: 16°-45°, Red: 46°+).
  - ⚡ **Free Fall Velocity Meter (Kinematics):** A glowing vertical power gauge tracking downward velocity in real-time upon block release, transitioning from cool Cyan to hot Red as kinetic energy builds before impact. Designed with large, high-legibility typography for an effortless STEM learning experience.
